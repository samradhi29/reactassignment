...
export default function CreateAccount() {
  ...
  const renderInputField = (label, type, name, placeholder) => (
    <fieldset className="mb-3 w-[100%] border border-gray-300 p-1 rounded-md">
      <legend className="text-gray-700 font-medium text-sm">
        {label}{name !== "companyName" && <span className="text-red-500">*</span>}
      </legend>
      <input
        type={type}
        name={name}
  ...
  return (
    <div className="h-[80vh] bg-white p-6 flex flex-col justify-start items-center">
      ...
      <form
        className="flex flex-col gap-2 text-left w-[80%] max-w-[700px]"
